    ...
    steps: [
      {
        ...
        desc: "Netlify, chon site, Site configuration, Environment variables, Add variable. Them 6 bien:\n  NEXT_PUBLIC_SUPABASE_URL\n  NEXT_PUBLIC_SUPABASE_ANON_KEY\n  SUPABASE_SERVICE_ROLE_KEY\n  ADMIN_PASSWORD\n  ADMIN_SECRET\n  CRON_SECRET",
        links: [
          { label: "Netlify Dashboard", href: "https://app.netlify.com/" },
          { label: "Tạo chuỗi random", href: "https://generate-secret.vercel.app/40" },
        ],
        tips: "ADMIN_SECRET phai la chuoi ngau nhien phuc tap 32+ ky tu.",
      },
      {
        id: "netlify-deploy",
        title: "Trigger Redeploy",
        desc: "Netlify, Deploys, Trigger deploy, Deploy site. Cho ~2-3 phut. Truy cap domain xac nhan site chay. Thu dang nhap /admin/login.",
        links: [{ label: "Netlify Deploys", href: "https://app.netlify.com/" }],
        tips: "Neu site bao loi 500, kiem tra lai Supabase keys trong Netlify env vars.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        tips: "Webhook URL phai HTTPS. Netlify tu dong co HTTPS. Test thu bang nut Test trong SePay.",
      },
    ],
  },
  {
