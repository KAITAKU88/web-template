...
export default function AdminShell({
  ...
  return (
    // class="dark" cố định — admin luôn dùng dark mode
    <div className="dark fixed inset-0 z-[9999] flex bg-gray-950 overflow-hidden">
      {/* Backdrop mobile */}
      {mobileOpen && (
        <div
      ...
      <div className="flex flex-1 flex-col overflow-hidden min-w-0">
        ...
        <div className="flex h-14 shrink-0 items-center gap-3 border-b border-gray-800 bg-gray-900 px-4 md:hidden">
          ...
          <span className="flex-1 text-sm font-semibold text-white">{brandName}</span>
        </div>
