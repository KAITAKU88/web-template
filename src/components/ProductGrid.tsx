  ...
  return (
    <div>
      ...
      <div className="mb-6 flex gap-1.5 sm:hidden">
        {categories.length > 0 && (
          <>
            <label htmlFor="filter-category-mobile" className="sr-only">Danh mục</label>
            <select
        ...
        <label htmlFor="filter-price-mobile" className="sr-only">Khoảng giá</label>
        <select
        ...
        <label htmlFor="filter-sort-mobile" className="sr-only">Sắp xếp</label>
        <select
      ...
      <div className="mb-6 hidden sm:flex flex-wrap items-center gap-2">
        {categories.length > 0 && (
          <>
            {categories.length <= 5 ? (
              ...
              <>
                <label htmlFor="filter-category-desktop" className="sr-only">Danh mục</label>
                <select
        ...
        <div className="ml-auto flex items-center gap-2">
          <label htmlFor="filter-price-desktop" className="sr-only">Khoảng giá</label>
          <select
          ...
          <label htmlFor="filter-sort-desktop" className="sr-only">Sắp xếp</label>
          <select
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <div className="mt-auto flex items-end justify-between gap-2">
                    <div>
                      ...
                      {discount && product.original_price && (
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="rounded-full bg-red-500/10 px-2.5 py-0.5 text-xs font-medium text-red-700 dark:text-red-400">-{discount}%</span>
                        </div>
                      )}
                    </div>
                    {/* Nút + mèo chạy Lottie */}
                    <div className="relative flex-shrink-0">
                      ...
                      <div className="pointer-events-none select-none absolute -top-[56px] left-1/2 w-36 -translate-x-[calc(50%+16px)] opacity-0 transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover:-translate-x-1/2 group-hover:opacity-100">
